...
(named {\tt scan}, but you can name it something else if you want) Please use statements like {\tt ... = scan.next()},
{\tt ... = scan.nextInt()}, and {\tt ... = scan.nextDouble()} to read in strings, integers, and general numbers. Your
program should produce output that is neat and your program's source code must make good use of white space and
labeling.
