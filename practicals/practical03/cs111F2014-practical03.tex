...
\noindent Remember to ``{\tt import java.util.Scanner}'' at the top of your Java program and to declare a {\tt Scanner} variable
(named {\tt scan}, but you can name it something else if you want) Please use statements like ``{\tt ... =
  scan.next()}'', ``{\tt ... = scan.nextInt()}'', and ``{\tt ... = scan.nextDouble()}'' to read in strings, integers,
and double values. Your program should produce output that is neat and your program's source code must make good use of
white space and labeling.
