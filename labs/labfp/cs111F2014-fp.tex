...
\begin{enumerate}
  ...
  \item {\bf Performance Evaluation}: Since it is often important to implement computer software that exhibits
    ...
    software like Caliper.  After finding, reading, and understanding textbooks and research papers in this area,
...
five methods in addition to the {\tt main} method. The final project source code should also contain examples of the
...
iteration constructs, expressed as {\tt while}, {\tt do-while}, and {\tt for} loops.
