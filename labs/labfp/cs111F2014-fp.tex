...
in your report. Also, the report must explain the steps to run your own Java program.  Finally, the report must detail
...
\begin{enumerate}
  ...
  \item {\bf Project Assigned and Project Proposal:} Thursday, November 20, 2014
    ...
    team selects the student-designed project, you must first have your project verified by the course instructor.
